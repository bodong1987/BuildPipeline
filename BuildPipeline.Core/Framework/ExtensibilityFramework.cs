...
namespace BuildPipeline.Core.Framework
{
    ...
    public static class ExtensibilityFramework
    {
            ...
            where T : IComposableTarget
        {
            ...
            foreach(var m in type.GetMembers())
            {
                    ...
                    )
                {
                    ...
                    ComposeMember(target, accessToken, m, attr); //-V3080
                }
            }
        ...
        private static void ComposeMember<T>(T target, object accessToken, MemberInfo memberInfo, ImportAttribute attribute)
            where T : IComposableTarget
        {
            Type listType;
            ...
            ComposeList(list, interfaceType, attribute.ContractName, attribute.RequiredCreationPolicy, memberInfo, accessToken);
