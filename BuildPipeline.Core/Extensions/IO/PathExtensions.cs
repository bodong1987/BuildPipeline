...
namespace BuildPipeline.Core.Extensions.IO
{
    /// <summary>
    ...
    public static class PathExtensions
    {
        ...
        private static bool EndsWithPathSeparator(this string path)
        {
        ...
        public static bool IsReadOnlyFile(this string path)
        {
            if(path.IsNullOrEmpty())
            {
                return false;
