...
namespace BuildPipeline.Core.Extensions
{
    ...
    public static class RandomExtensions
    {
        ...
        {
            return FromFloatRGBA(random.NextFloat(0.0f, 1.0f), random.NextFloat(0.0f, 1.0f), random.NextFloat(0.0f, 1.0f), 1.0f);
        }
        ...
        {
            return FromFloatRGBA(random.NextFloat(minBrightness, maxBrightness), random.NextFloat(minBrightness, maxBrightness), random.NextFloat(minBrightness, maxBrightness), 1.0f);
        }
