...
namespace BuildPipeline.Core.Utils
{
    ...
    /// <seealso cref="IState" />
    public abstract class AbstractImportableState :
        AbstractImportable,
        IImportable,
        IState
    {
    ...
    public class StateMachine
    {
        ...
        /// <summary>
        /// Registers the state by attributes.
        /// </summary>
        /// <typeparam name="TAttributeType">The type of the t attribute type.</typeparam>
        /// <param name="assemblies">The in assemblies.</param>
        /// <param name="args">The arguments.</param>
        /// <returns>ClassEnumerator.</returns>
        public ClassEnumerator RegisterStateByAttributes<TAttributeType>(Assembly[] assemblies, params object[] args)
            where TAttributeType : AutoRegisterStateAttribute
        {
            ...
            while (Iter.MoveNext())
            {
                ...
                IState StateObj = (IState)Activator.CreateInstance(StateType, args);
        ...
        /// <param name="assemblies">The in assemblies.</param>
        /// <returns>ClassEnumerator.</returns>
        public ClassEnumerator RegisterStateByAttributes<TAttributeType>(Assembly[] assemblies)
            where TAttributeType : AutoRegisterStateAttribute
        {
            var Classes = new ClassEnumerator(
                typeof(TAttributeType),
            ...
            while (Iter.MoveNext())
            {
                ...
                IState StateObj = (IState)Activator.CreateInstance(StateType);
        ...
        public IState ChangeState(string name)
        {
            if (name == null)
            {
                Logger.LogWarning("没有状态机类型，使用默认类型：");
                return default;
            }
